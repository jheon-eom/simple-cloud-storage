...
import com.eomproject.simple_storage.file.adapter.out.filesystem.CreateDirectoryFileSystemAdapter;
import com.eomproject.simple_storage.file.adapter.out.persistance.SaveDirectoryJpaAdapter;
...
class RegisterUserServiceTest {
    ...
    void 회원가입이_성공하면_유저_데이터와_루트_디렉토리_메타데이터가_디비에_저장되고_루트_디렉토리가_생성된다() {
        ...
        RegisterUserService registerUserService =
                new RegisterUserService(passwordManager, registerUserPort, createDirectoryUseCase);
